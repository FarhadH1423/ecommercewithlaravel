...
<!-- banner -->
	...
	<div class="banner">
			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						<li><a href="products.html">Branded </a></li>
		...
		<div class="w3l_banner_nav_right">
			...
			<!-- flexSlider -->
				<link rel="stylesheet" href="{{asset('assets/user/css/flexslider.css')}}" type="text/css" media="screen" property="" />
...
<!-- banner -->
	<div class="banner_bottom">
			...
			<div class="wthree_banner_bottom_left_grid_sub1">
				...
				<div class="col-md-4 wthree_banner_bottom_left">
					<div class="wthree_banner_bottom_left_grid">
						<img src="{{asset('assets/user/images/6.jpg')}}" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 top_brand_left">
					<div class="hover14 column">
						<div class="agile_top_brand_left_grid">
							<div class="tag"><img src="{{asset('assets/user/images/tag.png')}}" alt=" " class="img-responsive" /></div>
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="{{asset('assets/user/images/1.png')}}" /></a>		
						...
						<div class="agile_top_brand_left_grid">
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block" >
										<div class="snipcart-thumb">
											<a href="single.html"><img title=" " alt=" " src="{{asset('assets/user/images/3.pn')}}g" /></a>		
						...
						<div class="agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="{{asset('assets/user/images/2.png')}}" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="single.html"><img src="{{asset('assets/user/images/4.png')}}" alt=" " class="img-responsive" /></a>
											<p>dogs food (4 Kg)</p>
				...
				<div class="col-md-9 w3l_fresh_vegetables_grid_right">
					<div class="col-md-4 w3l_fresh_vegetables_grid">
						<div class="w3l_fresh_vegetables_grid1">
							<img src="{{asset('assets/user/images/8.jpg')}}" alt=" " class="img-responsive" />
						</div>
					</div>
					<div class="col-md-4 w3l_fresh_vegetables_grid">
						<div class="w3l_fresh_vegetables_grid1">
							<div class="w3l_fresh_vegetables_grid1_rel">
								<img src="{{asset('assets/user/images/7.jpg')}}" alt=" " class="img-responsive" />
						...
						<div class="w3l_fresh_vegetables_grid1_bottom">
							<img src="{{asset('assets/user/images/10.jpg')}}" alt=" " class="img-responsive" />
					...
					<div class="col-md-4 w3l_fresh_vegetables_grid">
						<div class="w3l_fresh_vegetables_grid1">
							<img src="{{asset('assets/user/images/9.jpg')}}" alt=" " class="img-responsive" />
						</div>
						<div class="w3l_fresh_vegetables_grid1_bottom">
							<img src="{{asset('assets/user/images/11.jpg')}}" alt=" " class="img-responsive" />
						</div>
					</div>
					<div class="clearfix"> </div>
