...
<!-- font-awesome icons -->
<link href="{{asset('assets/user/css/font-awesome.css')}}" rel="stylesheet" type="text/css" media="all" /> 
<!-- //font-awesome icons -->
<!-- js -->
		...
		<div class="product_list_header">  
			<form action="#" method="post" class="last">
                <fieldset>
                    ...
                    <a href="{{ route('cart.index') }}" class="btn btn-success "> <i class="fa fa-shopping-cart"></i> View your Cart-{{$allcart}}<a>
                </fieldset>
            </form>
		</div>
        ...
        <div class="agile_footer_grids">
            <div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
                <div class="w3_footer_grid_bottom">
                    ...
                    <img src="{{asset('assets/user/images/card.png')}}" alt=" " class="img-responsive" />
                </div>
            </div>
            <div class="col-md-3 w3_footer_grid agile_footer_grids_w3_footer">
                <div class="w3_footer_grid_bottom">
...
<script src="{{asset('assets/user/js/minicart.js')}}"></script>
<script>
